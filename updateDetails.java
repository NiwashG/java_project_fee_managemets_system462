...
//        }
         ...
         if(txt_Roll_no1.getText().trim().equals("") ){
...
//                  }
    ...
    public void fillComboBox(){
       try{
           ...
           PreparedStatement pst=con.prepareStatement("select Cname from cfeems");
...
//        String studentName=txt_.getText();
        ...
        try
        {
            ...
            PreparedStatement pst=con.prepareStatement("update fees_Details set student_name=?,roll_no=?,"
                    + "payment_mode=?,cheque_no=?,bank_name=?,dd_no=?,"
                    + "course_name=?,gstin=?,total_amount=?,date=?,amount=?,cgst=?,sgst=?,total_in_words=?,"
            ...
            pst.setString(14,totalInWoords);
    ...
    public void setRecord(){
        try
        {
            ...
            PreparedStatement pst=con.prepareStatement("select* from fees_Details order by reciept_no desc limit 1");
             ...
             jComboBoxPayment_mode.setSelectedItem(rs.getString("payment_mode"));
             ...
             txt_Recived_from.setText(rs.getString("student_name"));
                  date1.setDate(rs.getDate("date"));
...
//        String date =Format.format(date1.getDate());
             ...
             txt_Roll_no1.setText(rs.getString("roll_no"));
             jComboBoxCourse.setSelectedItem(rs.getString("course_name"));
      ...
      // txt_gst_in.setText(rs.getString("gstin"));
             txt_Remark_Area.setText(rs.getString("remark"));
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 50, 50, 430));
        ...
        date1.setDateFormatString("MMM d,y");
        date1.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        date1.setMinSelectableDate(new java.util.Date(-62135785721000L));
